...
{{-- 
                                ...
                                <a href="#msg" class="f1-s-3 cl8 hov-cl10 trans-03 m-r-15">
                                    {{count($blog->comments)}} Comment
                                </a>
                            </div>

                            <div class="wrap-pic-max-w p-b-30">
                                <img src="{{ asset('blogsImages') }}/{{ $blog->image }}" alt="IMG">
                            </div>
                            ...
                            <div class="flex-s-s">
                                ...
                                <div class="flex-wr-s-s size-w-0">
                                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode($url) }}&quote={{ urlencode($excerpt) }}" target="_blank"
                        ...
                        <!-- Leave a comment -->
                        <div>
                            <h4 id="msg" class="f1-l-4 cl3 p-b-12">
                                Leave a Comment
                            </h4>
                            ...
                            <p class="f1-s-13 cl8 p-b-40">
                                لن يتم مشاركة بريدك الالكتروني مع اي جهة
                            </p>

                            <form method="POST" action="{{route('comments.store',$blog)}}">
                                @csrf
                                <textarea class="bo-1-rad-3 bocl13 size-a-15 f1-s-13 cl5 plh6 p-rl-18 p-tb-14 m-b-20" name="text"
                            ...
                            <ul class="p-t-35">
                                <li class="flex-wr-sb-s p-b-30">
                                    <a href="#" class="size-w-10 wrap-pic-w hov1 trans-03">
                                        <img src="{{ asset('images/popular-post-04.jpg') }}" alt="IMG">
                                    </a>
                                ...
                                <li class="flex-wr-sb-s p-b-30">
                                    <a href="#" class="size-w-10 wrap-pic-w hov1 trans-03">
                                        <img src="{{ asset('images/popular-post-05.jpg') }}" alt="IMG">
                                    </a>
                                ...
                                <li class="flex-wr-sb-s p-b-30">
                                    <a href="#" class="size-w-10 wrap-pic-w hov1 trans-03">
                                        <img src="{{ asset('images/popular-post-06.jpg') }}" alt="IMG">
                                    </a>
