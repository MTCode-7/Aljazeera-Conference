        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 d-flex align-items-stretch">
                    <div class="card w-100">
                        <div class="card-body p-4">
                            <h5 class="card-title fw-semibold mb-4">Adminstrator</h5>
                                ...
                                <table class="table text-nowrap mb-0 align-middle">
                                    <thead class="text-dark fs-4">
                                        <tr>
                                            ...
                                            <th class="border-bottom-0">
                                                <h6 class="fw-semibold mb-0">الاسم</h6>
                                            </th>
                                            <th class="border-bottom-0">
                                                <h6 class="fw-semibold mb-0">تاريخ الانضمام</h6>
                                            </th>
                                            <th class="border-bottom-0">
                                                <h6 class="fw-semibold mb-0">النوع</h6>
                                            </th>
                                            <th class="border-bottom-0">
                                            ...
                                            @if ($admin->utype == 'admin')
                                                <tr>
                                                    ...
                                                    <td class="border-bottom-0">
                                                        ...
                                                        <span class="fw-normal">{{ $admin->email }}</span>
                                                    </td>
                                                    <td class="border-bottom-0">
                                                        <p class="mb-0 fw-normal">{{ $admin->created_at->diffForHumans() }}
                                                        </p>
                                                    </td>
                                                    <td class="border-bottom-0">
                                                        <div class="d-flex align-items-center gap-2">
                                                            <span
                                                                class="badge bg-primary rounded-3 fw-semibold">{{ $admin->admin_type }}</span>
                                                        </div>
                                                    </td>
                                                    <td class="border-bottom-0 row">
                                                        @if (Auth::user()->admin_type == 'super admin' && $admin->admin_type == 'admin')
                                                        <a class="col-6" href="http://"><i
                                                            class="fa fa-trash text-danger"
                                                            aria-hidden="true"></i></a>
                                                        @endif
                                                        <a class="col-6" href="http://"><i class="fa fa-eye" aria-hidden="true"></i></a>
            ...
            <div class="py-6 px-6 text-center">
                <p class="mb-0 fs-4">Design and Developed by <a href="https://adminmart.com/" target="_blank"
                        class="pe-1 text-primary text-decoration-underline">Mohammed Tawfig</a> Marker <a
                        href="https://themewagon.com">MTCode</a></p>
            </div>
        </div>
    {{-- </div> --}}
@endsection
